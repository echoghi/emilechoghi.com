		...
		skills: [
			{
				...
				image: responsiveImg,
				text:
					"The majority of people on the internet these days are not just sitting in front of their desktop computers; they're on their phones, tablets, and a bunch of other handheld devices. Almost every project that I've worked on is coded with the expectation that it could be used on any device, so I strive to keep the user's experience effortless, flexible, and clean.",
				key: 0
			},
			{
							...
							<div className="jumbotron__container">
								<div className="jumbotron__content">
									...
									<p>
										...
										building sites for clients using the
										most up to date software available,
										kicking off each new project with a
										custom toolkit of ideas and a fresh
										approach built to match your needs.
									</p>
								</div>
							</div>
						</div>
